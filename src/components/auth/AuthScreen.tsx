...
export function AuthScreen() {
  ...
  // A diferencia de signIn/signUp, si signInWithOAuth tiene éxito el
  // navegador navega fuera de la app (a Google) — no hay un "termina bien"
  // que gestionar aquí, solo el caso de que ni siquiera llegue a redirigir.
